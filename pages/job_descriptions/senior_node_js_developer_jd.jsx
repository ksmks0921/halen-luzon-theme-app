...
export default class senior_node_js_developer_jd extends Component {
    ...
    render() {
        return (
            ...
            <PageBanner
            pageTitle="Senior Node JS Developer"
            homePageUrl="/"
            homePageText="Careers"
            activePageText="Senior Node JS Developer"
            bgImage="item-bg-1"
            />
                <div className="main-content" style={{padding: "20px"}}>
                    <div className="container" id="career-main">
                        <div className="row">
                            <div className="col-lg-12">
                                <h1>Senior Node JS Developer</h1>
                            </div>
                        ...
                        <p>As a Senior Node.js, API Services Developer you will participate in all aspects of the software development lifecycle which includes estimating, technical design, implementation, documentation, testing, deployment, and support of application developed for our clients. As a member working in a team environment you will take direction from solution architects and Leads on development activities.</p>
                        <hr />
                        <h4>Responsibilities</h4>
                        <ul>
                            <li>Responsible for development, programming, coding of complex and business critical Information Technology solutions using Nodejs</li>
                        ...
                        <ul>
                            ...
                            <li>Halen full-time employees receive complete and competitive benefits. We offer a collaborative work environment, competitive compensation, generous work/life opportunities and an outstanding benefits package that includes paid time off plus holidays. In addition, all colleagues are eligible for a number of rewards and recognition programs including billable bonus opportunities. Encouraging a healthy work/life balance and providing our colleagues great benefits are just part of what makes Halen a great place to work.</li>
                        </ul>
                        <hr />
                        <h4>Perks</h4>
                    ...
                    <div className="container" id="career-main" style={{width: "15%"}}>
                        <h3>Share This Job</h3>
                            <SocialLinks postText={"Senior Node JS Developer position at Halen!"}/>
                        <h3>Related Jobs</h3>
                        <a href="http://localhost:3000/job_descriptions/api_developer_jd/">Senior API Developer</a><br/>
                        <a href="http://localhost:3000/job_descriptions/api_developer_jd/">Security Engineer</a>
                    </div>
                </div>
                <Footer />
</>
